...
public partial class FuflowerBouquetManagementV4Context : DbContext
{
	...
	private string GetConnectionString()
	{
		IConfiguration config = new ConfigurationBuilder()
			...
			.Build();
		var strConn = config["ConnectionStrings:FlowerDB"];
		return strConn;
	}
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2B0CC9DC34");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B843272E82");
        ...
        {
            entity.HasKey(e => e.FlowerBouquetId).HasName("PK__FlowerBo__A1391301F6930C51");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BAF9745A151");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.FlowerBouquetId }).HasName("PK__OrderDet__C983CA9FAB55965D");
